#
# Be sure to run `pod lib lint VEGUtils.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'VEGUtils/Classes/**/*'
  
  # s.resource_bundles = {
  #   'VEGUtils' => ['VEGUtils/Assets/*.png']
  # }
  ...
  s.platform = :ios
  s.vendored_frameworks = '**/VEGDevopmentKit.framework'
end
